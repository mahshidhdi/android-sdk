...
/**
 * -- Modified version of io.reactivex.exceptions.CompositeException --
 *
...
public class CompositeException extends RuntimeException {
     ...
     */
    public CompositeException(String message, Throwable... exceptions) {
        this(message, exceptions == null ?
     ...
     */
    public CompositeException(String message, Iterable<? extends Throwable> errors) {
