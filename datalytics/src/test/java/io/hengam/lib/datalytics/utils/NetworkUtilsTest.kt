package io.hengam.lib.datalytics.utils
...
class NetworkUtilsTest {
    ...
    private val networkUtils = NetworkUtils(moshi, httpUtils, hengamConfig)

    private fun setApiList(vararg apiList: String) {
        hengamConfig.updateConfig("public_ip_apis", List::class.java, apiList.toList())
    }
