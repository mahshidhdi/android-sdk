...
class GeofenceManager @Inject constructor(
     ...
     */
    val geofences: PersistedMap<GeofenceMessage> = pusheStorage.createStoredMap(
            "geofences",
            GeofenceMessage::class.java,
            GeofenceMessageJsonAdapter(pusheMoshi.moshi)
    )
     ...
     */
    val geofenceTriggerCounts: PersistedMap<Int> = pusheStorage.createStoredMap(
            "geofence_counts",
     ...
     * here should not have expiration times and should be stored for the lifetime of the installation.
     */
    val geofenceTriggerTimes: PersistedMap<Time> = pusheStorage.createStoredMap(
            "geofence_times",
            Time::class.java
    )
    ...
    init {
        ...
        pusheLifecycle.onBootCompleted.justDo(T_DATALYTICS, T_GEOFENCE) { this.ensureGeofencesAreRegistered().justDo(T_DATALYTICS, T_GEOFENCE) }
    }
