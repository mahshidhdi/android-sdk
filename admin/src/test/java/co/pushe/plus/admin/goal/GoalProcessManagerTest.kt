package co.pushe.plus.admin.goal

import android.support.v4.app.Fragment
import android.widget.Button
import android.widget.TextView
import co.pushe.plus.admin.R
import co.pushe.plus.admin.analytics.activities.MultipleFrameLayoutActivity
...
class GoalProcessManagerTest {
    ...
    fun manageActivityButtonClickGoals_checksIfViewWithGivenButtonIdIsAButton() {
        ...
        mockkStatic("co.pushe.plus.analytics.utils.GetOnClickListenerKt")
...
private val viewGoalDataList_simpleActivity =
        listOf(
                ...
                ViewGoalData(
                        ...
                        parentGoalName = "firstActivityReachGoal",
                        targetValues = listOf(),
                        goalFragmentInfo = GoalFragmentInfo("co.pushe.plus.admin.analytics.fragments.fragmentName", "co.pushe.plus.admin.analytics.fragments.aa", "fragmentID", "activityName")
                )
        )
...
private val fragmentBReachGoal = FragmentReachGoalData(
        ...
        ViewGoalData(
                ...
                goalFragmentInfo = GoalFragmentInfo(actualName = "co.pushe.plus.admin.analytics.fragments.FragmentB", obfuscatedName = null, fragmentId = "flContainer", activityName = "MultipleFrameLayoutActivity")
        ),
        ViewGoalData(
                viewType = ViewGoalType.TEXT_VIEW,
                viewID = "editTextSample",
...
private val viewGoalDataList_fragmentB =
        listOf(
                ViewGoalData(
                        ...
                        parentGoalName = "fragmentBReachGoal",
                        targetValues = listOf(),
                        goalFragmentInfo = GoalFragmentInfo("co.pushe.plus.admin.analytics.fragments.FragmentB", "co.pushe.plus.admin.analytics.fragments.b", "flContainer", "MultipleFrameLayoutActivity")
                ),
                ViewGoalData(
                        viewType = ViewGoalType.TEXT_VIEW,
                        viewID = "editTextSample",
