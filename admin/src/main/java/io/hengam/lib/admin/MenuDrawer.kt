...
import io.hengam.lib.admin.notificationTest.NotificationTestMainActivity
...
class MenuDrawer {
    fun initDrawer(activity: AppCompatActivity, activeItem: Long) {
        ...
        val notificationTestItem = SecondaryDrawerItem().withIcon(R.drawable.hengam_ic_check)
        ...
        val headerResult = AccountHeaderBuilder()
                ...
                .withTextColor(Color.WHITE)
                .addProfiles(
                        ProfileDrawerItem().withName("Hengam SDK Admin")
