...
import co.pushe.plus.notification.Constants.DEFAULT_CHANNEL_ID
...
import co.pushe.plus.notification.utils.FileHelper
...
class NotificationAppInstaller @Inject constructor(
    ...
    private val pendingInstallations = pusheStorage.createStoredMap(
